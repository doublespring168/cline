...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	...
	return {
		...
		vertexCustomModelInfo:
			mode === "plan" ? apiConfiguration.planModeVertexCustomModelInfo : apiConfiguration.actModeVertexCustomModelInfo,
...
export async function syncModeConfigurations(
	...
	switch (apiProvider) {
		...
		case "vertex":
			updates.planModeApiModelId = sourceFields.apiModelId
			updates.actModeApiModelId = sourceFields.apiModelId
			updates.planModeVertexCustomModelSelected = sourceFields.vertexCustomModelSelected
			updates.actModeVertexCustomModelSelected = sourceFields.vertexCustomModelSelected
			updates.planModeVertexCustomModelInfo = sourceFields.vertexCustomModelInfo
			updates.actModeVertexCustomModelInfo = sourceFields.vertexCustomModelInfo
			break
		case "huawei-cloud-maas":
