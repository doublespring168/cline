...
const ChatRow = memo(
	(props: ChatRowProps) => {
		...
		const [chatrow, { height }] = useSize(
			<div className="relative pt-2.5 pl-2 pr-1">
				...
				case "command":
					return [
						...
						<span className="font-bold text-foreground">
							coderX wants to execute this command:
						</span>,
					];
				case "use_mcp_server":
					...
					return [
						...
						<span className="ph-no-capture font-bold text-foreground break-words">
							...
							{mcpServerUse.type === "use_mcp_tool"
								...
								: "access a resource"}{" "}
							on the{" "}
							<code className="break-all">{mcpServerUse.serverName}</code> MCP
							server:
						</span>,
					];
			...
			switch (tool.tool) {
				case "editedExistingFile":
					...
					const editToolTitle = isApplyingPatch
						? "coderX is creating patches to edit this file:"
						: "coderX wants to edit this file:";
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
						...
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									coderX wants to delete this file:
								</span>
							</div>
							<CodeAccordian
								// isLoading={message.partial}
						...
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									coderX wants to create a new file:
								</span>
							</div>
							{backgroundEditEnabled && tool.path && tool.content ? (
								<DiffEditRow
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									coderX wants to read this file:
								</span>
							</div>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "coderX wants to view the top level files in this directory:"
										: "coderX viewed the top level files in this directory:"}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "coderX wants to recursively view all files in this directory:"
										: "coderX recursively viewed all files in this directory:"}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "coderX wants to view source code definition names used in this directory:"
										: "coderX viewed source code definition names used in this directory:"}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									coderX wants to search this directory for{" "}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									coderX is condensing the conversation:
								</span>
							</div>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									{message.type === "ask"
										? "coderX wants to fetch content from this URL:"
										: "coderX fetched content from this URL:"}
								</span>
							</div>
							<div
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									{message.type === "ask"
										? "coderX wants to search the web for:"
										: "coderX searched the web for:"}
								</span>
							</div>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">coderX loaded the skill:</span>
							</div>
						...
						return (
							<div className="flex flex-col bg-warning/20 p-2 rounded-xs border border-error">
								...
								<div className="text-foreground opacity-80">
									coderX may have trouble viewing the command's output. Please
						...
						return (
							<div className="p-2 bg-link/10 border border-link/30 rounded-xs">
								...
								<div className="text-foreground opacity-90 mb-2">
									Shell integration is unavailable or unstable. Commands will
									continue to run in the VS Code terminal.
								</div>
							</div>
						);
					case "task_progress":
							...
							<div>
								<div className={HEADER_CLASSNAMES}>
									...
									<span className="text-foreground font-bold">
										coderX wants to start a new task:
									</span>
								</div>
						...
						return (
							<div>
								<div className={HEADER_CLASSNAMES}>
									<FilePlus2Icon className="size-2" />
									<span className="text-foreground font-bold">
										coderX wants to condense your conversation:
									</span>
								</div>
								<NewTaskPreview context={message.text || ""} />
							</div>
