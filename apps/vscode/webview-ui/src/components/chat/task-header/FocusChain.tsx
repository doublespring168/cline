	...
	({ currentTaskItemId, lastProgressMessageText, showPlaceholderWhenEmpty }) => {
		...
		if (!todoInfo) {
			...
			return (
				<div
					aria-hidden={true}
					className="relative rounded-sm bg-[rgba(0,0,0,0.05)] flex items-center gap-2 select-none overflow-hidden opacity-80 px-2.5 py-2">
		...
		return (
			<div
				...
				className="relative rounded-sm bg-[rgba(0,0,0,0.05)] flex flex-col gap-1.5 select-none hover:bg-[rgba(0,0,0,0.05)] overflow-hidden opacity-80 hover:opacity-100 transition-[transform,box-shadow] duration-200 cursor-pointer"
