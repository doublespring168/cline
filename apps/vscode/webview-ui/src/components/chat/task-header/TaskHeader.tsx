...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	return (
		<div className="py-2 px-4 flex flex-col gap-2">
			...
			<div
				className={cn(
					"relative overflow-hidden cursor-pointer rounded-sm flex flex-col gap-1.5 z-10 pt-2 pb-2 px-2 hover:opacity-100 bg-[rgba(0,0,0,0.1)]",
					{
						"opacity-100 border-1": isTaskExpanded, // No hover effects when expanded, add border
						"hover:bg-[rgba(0,0,0,0.1)] border-1": !isTaskExpanded, // Hover effects only when collapsed
					},
				)}
				style={{
