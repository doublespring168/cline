...
const meta: Meta<typeof Button> = {
	...
	parameters: {
		docs: {
			description: {
				component:
					"Displays different types of error messages in the chat interface, including API errors, diff errors, and clineignore errors. Handles provider errors and presents appropriate local recovery actions.",
			},
		},
	},
}
