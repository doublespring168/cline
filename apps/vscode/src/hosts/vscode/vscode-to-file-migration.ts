 ...
 * that data to the extension's file-backed stores in ~/.coderx/data/.
 *
 * ## Migration semantics
 *
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.coderx/data/),
 ...
 *   to ~/.coderx/data/ so task storage no longer depends on the extension ID.
