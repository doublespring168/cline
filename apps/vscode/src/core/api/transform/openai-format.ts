 ...
 *
 * @param toolId - The original tool ID from coderX/Anthropic format
 ...
 *
 * Handles conversion of coderX-specific content types (tool uses, tool results, images, reasoning details)
